const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cyclical 계정',
    langGeniusAccountTip: 'Cyclical 계정과 관련된 사용자 데이터.',
    editName: '이름 편집',
  ...
  about: {
    changeLog: '변경 로그',
    updateNow: '지금 업데이트',
    nowAvailable: 'Cyclical {{version}} 사용 가능합니다.',
    latestAvailable: 'Cyclical {{version}} 최신 버전입니다.',
  },
  appMenus: {
    overview: '개요',
    promptEng: '오케스트레이트',
