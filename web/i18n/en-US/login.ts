const translation = {
  ...
  welcome: 'Welcome to Cyclical, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Cyclical Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Cyclical',
  invalid: 'The link has expired',
  explore: 'Explore Cyclical',
