const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cyclical account',
    langGeniusAccountTip: 'Your Cyclical account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Cyclical to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Cyclical allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Cyclical\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Cyclical {{version}} is now available.',
    latestAvailable: 'Cyclical {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
