    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see Cyclical\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, moCyclical it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and moCyclical it',
          step1Tip: 'Click here to fork the source code into your GitHub account and moCyclical the code',
