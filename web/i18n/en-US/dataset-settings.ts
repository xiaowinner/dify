const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Describe what is in this Knowledge. A detailed description allows AI to access the content of the Knowledge in a timely manner. If empty, Cyclical will use the default hit strategy.',
