const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Lời mời đã được gửi, và họ có thể đăng nhập vào Cyclical để truy cập vào dữ liệu nhóm của bạn.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      exhausted: 'HẾT QUOTA',
      desc: 'Dịch vụ lưu trữ OpenAI được cung cấp bởi Cyclical cho phép bạn sử dụng các mô hình như GPT-3.5. Trước khi hết lượng truy vấn dùng thử, bạn cần thiết lập các nhà cung cấp mô hình khác.',
  ...
  about: {
    ...
    nowAvailable: 'Cyclical {{version}} hiện đã có sẵn.',
    latestAvailable: 'Cyclical {{version}} là phiên bản mới nhất hiện có.',
  },
  appMenus: {
    overview: 'Tổng quan',
