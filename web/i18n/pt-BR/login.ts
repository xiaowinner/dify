const translation = {
  ...
  welcome: 'Bem-vindo ao Cyclical, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Cyclical, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Cyclical',
  invalid: 'O link expirou',
  explore: 'Explorar o Cyclical',
