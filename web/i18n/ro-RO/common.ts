const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în Cyclical pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de Cyclical vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  about: {
    ...
    nowAvailable: 'Cyclical {{version}} este acum disponibil.',
    latestAvailable: 'Cyclical {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
